  ...
  <?php include("Comun/menu.html"); ?>
      ...
      <div class="container-fluid">
        <div class="slider-text d-md-flex align-items-center" data-scrollax-parent="true">
          ...
          <div class="one-forth pr-md-4 ftco-animate align-self-md-center" data-scrollax=" properties: { translateY: '70%' }">
            ...
            <p data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><a href="#" class="btn btn-primary px-4 py-3">Empieza ahora</a></p>
          </div>
    ...
    <section class="ftco-section bg-light">
    	<div class="container">
          ...
          <div class="col-md-7 text-center heading-section ftco-animate">
            <span class="subheading">Consigue un dominio</span>
            <h2 class="mb-4">Consigue el nombre de tu dominio</h2>
            <p>Con Email gratis, DNS, Gran proteccion, y demas caracteristicas</p>
          </div>
        </div>
    		<div class="row justify-content-center">
              ...
              <div class="form-group d-md-flex">
                <input type="text" class="form-control px-4" placeholder="Ingresa en nombre del dominio...">
                <input type="submit" class="search-domain btn btn-primary px-5" value="Buscar dominio">
              </div>
            </form>
    ...
    <section class="ftco-section bg-light">
    	<div class="container">
    		<div class="row justify-content-center mb-5 pb-5">
          <div class="col-md-7 text-center heading-section ftco-animate">
            <span class="subheading">Planes principales</span>
            <h2 class="mb-4">Nuestros mejores hostings</h2>
          </div>
        </div>
    		<div class="row">
	        <div class="col-md-3 ftco-animate">
	          <div class="block-7">
	            ...
	            <span class="price"><sup>$</sup> <span class="number">25.000</span></span>
	            <span class="excerpt d-block">Mas economico</span>
	            <a href="https://biz.payulatam.com/B0c9270D35E7979"><img src="http://www.payulatam.com/img-secure-2015/boton_pagar_grande.png"></a>
	        ...
	        <div class="col-md-3 ftco-animate">
	          <div class="block-7">
	            ...
	            <span class="price"><sup>$</sup> <span class="number">50.000</span></span>
	            <span class="excerpt d-block">Medio</span>
	            <a href="https://biz.payulatam.com/B0c9270D35E7979"><img src="http://www.payulatam.com/img-secure-2015/boton_pagar_grande.png"></a>
	            ...
	            <ul class="pricing-text">
	              ...
	              <li><strong>$2.00 / GB</strong> Base de datos MySQL</li>
	            </ul>
	            </div>
	          </div>
	        </div>
	        <div class="col-md-3 ftco-animate">
	          <div class="block-7">
	            ...
	            <span class="price"><sup>$</sup> <span class="number">75.000</span></span>
	            <span class="excerpt d-block">Lo mejor de lo mejor</span>
	            <a href="https://biz.payulatam.com/B0c9270D35E7979"><img src="http://www.payulatam.com/img-secure-2015/boton_pagar_grande.png"></a>
